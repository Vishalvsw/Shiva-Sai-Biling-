...
const AdminCard: React.FC<{ title: string; description: string; icon: React.ReactNode }> = ({ title, description, icon }) => (
    <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow cursor-pointer border border-slate-200">
...
const AdminDashboard: React.FC = () => {
    ...
    return (
        <div className="bg-slate-50 p-6 rounded-xl shadow-lg space-y-4">
            <h2 className="text-2xl font-bold text-slate-800 border-b pb-2">Admin Dashboard</h2>
