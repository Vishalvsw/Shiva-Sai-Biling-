...
const SplashScreen: React.FC<{ labName: string }> = ({ labName }) => {
    return (
        <div className="flex items-center justify-center h-screen bg-gradient-to-br from-teal-400 to-cyan-600">
            <div className="text-center text-white">
                ...
                <p className="mt-2 text-lg text-cyan-100">Initializing Billing System...</p>
            </div>
        </div>
    );
};
